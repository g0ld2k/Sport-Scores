...
class ResultTest: XCTestCase {
    ...
    func testNbaResult() throws {
        ...
        let result = NbaResult(publicationDate: publicationDate, winner: winner, tournament: tournament, looser: looser, gameNumber: gameNumber, mvp: mvp)
    ...
    func testTennisResult() throws {
        ...
        let result = TennisResult(publicationDate: publicationDate, winner: winner, tournament: tournament, looser: looser, numberOfSets: numberOfSets)
